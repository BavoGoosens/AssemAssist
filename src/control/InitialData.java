...
public class InitialData {
     ...
     *
     * @param vmc The VehicleManufacturingCompany you want to initialize with some orders.
     */
    ...
    private boolean randomOrderGenerator(String orders, int model) {
        ...
        if (batchList.contains(count++)) number = 0;
        else if (this.body.size() != 0) number = rnd.nextInt(this.body.size());
        if (this.body.size() != 0) this.chosen.add(this.body.get(number));
        if (batchList.contains(count++)) number = 0;
        else if (this.color.size() != 0) number = rnd.nextInt(this.color.size());
        if (this.color.size() != 0) this.chosen.add(this.color.get(number));
        if (batchList.contains(count++)) number = 0;
        else if (this.engine.size() != 0) number = rnd.nextInt(this.engine.size());
        if (this.engine.size() != 0) this.chosen.add(this.engine.get(number));
        if (batchList.contains(count++)) number = 0;
        else if (this.gearbox.size() != 0) number = rnd.nextInt(this.gearbox.size());
        if (this.gearbox.size() != 0) this.chosen.add(this.gearbox.get(number));
        if (batchList.contains(count++)) number = 0;
        else if (this.seats.size() != 0) number = rnd.nextInt(this.seats.size());
        if (this.seats.size() != 0) this.chosen.add(this.seats.get(number));
        if (batchList.contains(count++)) number = 0;
        else if (this.airco.size() != 0) number = rnd.nextInt(this.airco.size());
        if (this.airco.size() != 0) this.chosen.add(this.airco.get(number));
        if (batchList.contains(count++)) number = 0;
        else if (this.spoiler.size() != 0) number = rnd.nextInt(this.spoiler.size());
        if (this.spoiler.size() != 0) this.chosen.add(this.spoiler.get(number));
        if (batchList.contains(count++)) number = 0;
        else if (this.wheels.size() != 0) number = rnd.nextInt(this.wheels.size());
        if (this.wheels.size() != 0) this.chosen.add(this.wheels.get(number));

        if (this.certification.size() != 0)
            this.chosen.add(this.certification.get(rnd.nextInt(this.certification.size())));
