...
public class VehicleModel {
     ...
     *
     * @param name The name for the new car model.
     * @param cms  The car model specification for the car new model.
     * @param    standardTimeToFinish The standard time to finish this car model.
     ...
     *
     * @param cms The car model specification for the car model.
     * @throws IllegalArgumentException | If the car model specification is equal to 'null'
     *                                  | cms == null
     */
     ...
     *
     * @param    name The name for the car model.
     * @throws IllegalArgumentException | If the name is equal to 'null' or is equal to the empty string
