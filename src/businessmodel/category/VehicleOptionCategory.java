...
public abstract class VehicleOptionCategory {
     ...
     *
     * @param option The new option for the car option category.
     * @throws IllegalArgumentException              | If the option is equal to 'null'
     *                                               | option == null
     * @throws IllegalVehicleOptionCategoryException | If the option is not a valid option for this car option category.
     ...
     *
     * @param option The option that needs to be removed.
     * @throws IllegalArgumentException | If the option is equal to 'null'
     *                                  | option == null
     */
     ...
     *
     * @param name The name of the option of the car option category.
     * @throws IllegalArgumentException | If the name is equal to 'null' or if there exists no option with the given name
     ...
     *
     * @param option The option that needs to be checked for the car option category.
     * @throws IllegalArgumentException | If the option is equal to 'null'
     *                                  | option == null
