...
public class VehicleOption {
     ...
     *
     * @param name     The name of the car option.
     * @param category The car option category of the car option.
     * @throws IllegalArgumentException | If category is equal to 'null'
     *                                  | category == null
     */
     ...
     *
     * @param name The name of the car option.
     * @throws IllegalArgumentException | If the name is equal to 'null' or the empty string.
    ...
    public boolean equals(Object carOption) throws IllegalArgumentException {
        if (carOption == null || !(carOption instanceof VehicleOption))
            throw new IllegalArgumentException("Cannot compare this object: " + carOption + " to a car option!");
