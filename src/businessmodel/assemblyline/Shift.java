...
public abstract class Shift {
     ...
     *
     * @param numberofworkposts the number of WorkPost's that an AssemblyLine has.
     * @param    hours the number of hours that a shift consist of.
     */
     ...
     *
     * @param    numberofworkposts the new number of WorkPost's of this Shift.
     */
     ...
     *
     * @param    hours The amount of TimeSlot's that need to bee created.
     */
