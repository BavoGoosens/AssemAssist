...
public class AssemblyLineScheduler implements Subject {
     ...
     *
     * @param time the time spent on last AssemblyLine status.
     * @throws IllegalNumberException if(time < 0)
     */
     ...
     *
     * @param order The order you want to schedule in.
     */
     ...
     *
     * @param algoName the name of the new algorithm.
     * @param options
