...
public class AssemblyLine implements Subject {
     ...
     *
     * @param order The order that has to be placed.
     ...
     *
     * @param newOrder The new order that needs to be added to the assembly line, when moved forward.
     * @throws IllegalStateException | If the assembly line cannot be advanced.
     * | !this.canAdvance()
     */
     ...
     *
     * @param timeCurrentStatus The time spent on the current status.
     */
     ...
     *
     * @param workPosts The work posts of the assembly line.
     */
     ...
     *
     * @param scheduler The assembly line scheduler of the assembly line.
     */
     ...
     *
     * @param models The models for which the assembly line is responsible.
     */
     ...
     *
     * @param state The state the assembly line needs to be set to.
     */
     ...
     *
     * @param    order The order the estimated completion time is requested for.
     ...
     *
     * @param scheduler The main scheduler of the assembly line.
     */
