...
public class WorkPost {
     ...
     *
     * @param name         The name of the work post
     * @param assemblyline .
     ...
     *
     * @param    order The new order the work post needs to start working on.
     ...
     *
     * @throws IllegalArgumentException | If the list of tasks is equal to 'null'
     *                                  | tasks == null
     * @param    tasks The tasks that are pending at the work post.
     */
    @SuppressWarnings("unchecked")
     ...
     *
     * @param carOptions A list of options that need to be installed.
     ...
     *
     * @param order The order that this work post needs to start working on.
     */
     ...
     *
     * @param responsibleTasks The new list with all the assembly tasks the work post is responsible for.
     * @throws IllegalArgumentException | If the list of responsible tasks is equal to 'null'
