...
public class CustomShopManager extends User {
     ...
     *
     * @param firstname The first name of the new customs shop manager.
     * @param lastname  The last name of the new customs shop manager.
     * @param username  The user name for the new customs shop manager.
