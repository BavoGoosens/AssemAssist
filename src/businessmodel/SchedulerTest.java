...
public class SchedulerTest {
	...
	public void setUp() throws Exception {
		...
		henk1.add(engine);
		henk1.add(wheels);
		Order order1 = new StandardCarOrder(c1,henk1, new CarModel("lol", new CarModelSpecification(henk1)));
		Order order2 = new StandardCarOrder(c2,henk1,new CarModel("lol", new CarModelSpecification(henk1)));
		Order order3 = new StandardCarOrder(c3,henk1,new CarModel("lol", new CarModelSpecification(henk1)));
		Order order4 = new StandardCarOrder(c4,henk1,new CarModel("lol", new CarModelSpecification(henk1)));
		Order order5 = new StandardCarOrder(c5,henk1,new CarModel("lol", new CarModelSpecification(henk1)));
		Order order6 = new StandardCarOrder(c6,henk1,new CarModel("lol", new CarModelSpecification(henk1)));
		Order order7 = new StandardCarOrder(c7,henk1, new CarModel("lol", new CarModelSpecification(henk1)));
		Order order8 = new StandardCarOrder(c8,henk1,new CarModel("lol", new CarModelSpecification(henk1)));
		Order order9 = new StandardCarOrder(c9,henk1,new CarModel("lol", new CarModelSpecification(henk1)));
		Order order10 = new StandardCarOrder(c10,henk1,new CarModel("lol", new CarModelSpecification(henk1)));
		Order order11 = new StandardCarOrder(c11,henk1,new CarModel("lol", new CarModelSpecification(henk1)));
		Order order12 = new StandardCarOrder(c12,henk1,new CarModel("lol", new CarModelSpecification(henk1)));
		Order order13 = new StandardCarOrder(c13,henk1,new CarModel("lol", new CarModelSpecification(henk1)));
		Order order14 = new StandardCarOrder(c14,henk1,new CarModel("lol", new CarModelSpecification(henk1)));
		Order order15 = new StandardCarOrder(c15,henk1,new CarModel("lol", new CarModelSpecification(henk1)));
		Order order16 = new StandardCarOrder(c16,henk1,new CarModel("lol", new CarModelSpecification(henk1)));
		Order order17 = new StandardCarOrder(c17,henk1,new CarModel("lol", new CarModelSpecification(henk1)));
		Order order18 = new StandardCarOrder(c18,henk1,new CarModel("lol", new CarModelSpecification(henk1)));
