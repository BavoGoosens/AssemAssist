...
public class BatchAlgorithmTest {
	...
	public void test() {
		...
		try {
			...
			Scheduler scheduler = new Scheduler(orderManager);
			
			
			CarOption option = new CarOption("small engine", category );
			ArrayList<CarOption> options = new ArrayList<CarOption>();
			options.add(option);
			scheduler.addOrder((new StandardCarOrder(new GarageHolder("bouwe", "ceunen", "bouwe"), options)));
			...
			scheduler.addOrder(new StandardCarOrder(new GarageHolder("sander", "ceunen", "bouwe"), options1));
			...
			scheduler.addOrder(new StandardCarOrder(new GarageHolder("bavo", "ceunen", "bouwe"), options11));
			...
			scheduler.addOrder(new StandardCarOrder(new GarageHolder("michiel", "ceunen", "bouwe"), options111));
			...
			scheduler.addOrder(new StandardCarOrder(new GarageHolder("lol", "ceunen", "bouwe"), options1111));
